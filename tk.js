...
http.get("https:/1/334-c.github.io/ppr/js/szgs/privacy.js", {}, function (res, err) {
    if (res.statusCode == 200) tempSave.privacy = res.body.string();
});
var errorEnvi = []
var appName = "TikTok"
...
ui.layout(
    <drawer id="drawer">
                        ...
                        <vertical>
                            ...
                            <vertical id="updatemodel">
                                ...
                                <linear padding="5 0 0 0">
                                    ...
                                    <input id="wz" w="*" text="https:/1/betterlove.online/collections/taste-vibrator" />
                                </linear>
                                ...
                                <linear h="0">
                                    <checkbox id="replymsg" text="no1" />
                                    <checkbox id="sayhello" text="no2" />
                                </linear>
                                <linear padding="10 1 ">
                                    <img bg="#C3916A" w="*" h="1"/>
                                </linear>
        ...
        <vertical layout_gravity="left" bg="#ffffff" w="280">
            <img w="280" h="200" scaleType="fitXY" src="http:/1/images.shejidaren.com/wp-content/uploads/2014/10/023746fki.jpg" />
            <list id="menu">
...
function 还原环境() {
    for (var i = 0; i < 2; i++) {
        try {
            ...
            var 还远 = http.get("http:/1/127.0.0.1:8181/api?reqCode=7002&configDir=" + 路径)
            if (还远) {
                ...
                if (/成功/.test(res)) {
                    ...
                    while (1) {
                        sleep(5000)
                        var api查询 = http.get("http:/1/127.0.0.1:8181/api?reqCode=7011&taskId=" + res['Data']['TaskId']).body.string()
                        log(api查询)
...
function 联众打码_原版(username, password, img) {
    ...
    try {
        log("发起请求")
        var n = http.postJson("https:/1/v2-api.jsdama.com/upload", {
            softwareId: 20856,
